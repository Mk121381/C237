...
app.post('/addBook', (req, res) => {
	...
	books.push({ id: newId, title: req.body.title, author: req.body.author });	// add new book to books array
	res.redirect('/books');				// redirect to another route to display book list
});
// Middleware to parse form data from POST requests
app.use(express.urlencoded({ extended: true }));
